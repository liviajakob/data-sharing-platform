/* Ice Explorer - Detailed Dataset Viev
 * Manages All actions when user clicks on a dataset; 
 * - zoom to extent and display dataset and layer information
 * 
 * 1. Request dataset information
 * 2. Zoom smoothly to extent
 * 3. Set Polygonlayer invisible
 * 
 * Author: Livia Jakob
 * */
...
//TODO: clickdataset assure that can't be false for a long time...
 ...
 /* Zoom to layer on click on extent polygon
  * */
 var featureListener = function(event, feature) {
	 // request dataset information with timelayers
...
/* HELPER METHOD: Returns layer with id id_
 * 
 * */
